...
let mainContent =
'<h1>Welcome to the material for the NGS Summer School</h1>'
+ '<p>This page contains some basic information and resources to help you Navigating the material effectively.</p>'
+ '<br>'
+ '<p>For more info about the material visit, see <a href="https://hds-sandbox.github.io/NGS_summer_course_Aarhus" target="_blank">the course website</a>.</p>'
+ '<br>'
+ '<h2>Find the interactive notebooks</h2>'
+ '<p>You can find the code for the course into jupyter notebooks. Those are located'
+ 'in the folder <b>Intro_to_NGS/Notebooks</b> located on the left-side browser of your window </p>'
+ '<br>'
+ '<h2>Saving the datasets and notebooks on uCloud</h2>'
+ '<p>If you are using this material on the computing cluster uCLoud, the data and notebooks are stored will not be automatically saved'
